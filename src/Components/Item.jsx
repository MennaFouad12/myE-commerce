...
import { addTolistapi } from '../Apis/wishlistApi';
    ...
    <div className='w-2/4 md:w-1/4 lg:w-1/6 shadow-md'>
      <div className="product p-2 cursor-pointer">
        ...
        <div className='flex justify-between items-center my-3'>
          ...
          <i onClick={() =>{ setFlag(!flag);addlistmutate(prod?._id) }} className={`fas fa-heart cursor-pointer ${flag ? 'text-red-700' : 'text-gray-300'}`}></i>
        </div>
      </div>
    </div>
  );
